...
{
    public partial class Uc_responsavel : UserControl, uc_identificacao, conteudos_dinamicos
    {
        #region DADOS
        ...
        public Uc_responsavel(frm_principal principal)
        {
        ...
        #region ROTINAS
        private void Uc_responsavel_Load(object sender, EventArgs e)
        {
        ...
        private void pnl_cadastrar_responsavel_botao_Click(object sender, EventArgs e)
        {
         utilidades.carregarConteudoUControle(this,this.pnl_conteudo,false,new Uc_responsavel_cadastro(principal));
        }        
        private void pnl_pesquisar_responsavel_botao_Click(object sender, EventArgs e)
        {
          utilidades.carregarConteudoUControle(this,this.pnl_conteudo,false,new Uc_responsavel_pesquisa(principal));
        }
        ...
        {
            return "Área de gerenciamento de Responsáveis";
        }
        ...
        private void pnl_cadastrar_responsavel_botao_MouseDown(object sender, MouseEventArgs e)
        {
            pnl_cadastrar_responsavel_botao.BackColor = Color.FromArgb(51, 133, 148);
        }
        private void pnl_cadastrar_responsavel_botao_MouseLeave(object sender, EventArgs e)
        {
            pnl_cadastrar_responsavel_botao.BackColor = Color.FromArgb(11, 100, 117);
        }
        private void pnl_cadastrar_responsavel_botao_MouseHover(object sender, EventArgs e)
        {
            pnl_cadastrar_responsavel_botao.BackColor = Color.FromArgb(16, 118, 137);
        }
        private void pnl_cadastrar_responsavel_botao_MouseUp(object sender, MouseEventArgs e)
        {
            pnl_cadastrar_responsavel_botao.BackColor = Color.FromArgb(16, 118, 137);
        }
        private void pnl_pesquisar_responsavel_botao_MouseLeave(object sender, EventArgs e)
        {
            pnl_pesquisar_responsavel_botao.BackColor = Color.FromArgb(11, 100, 117);
        }
        private void pnl_pesquisar_responsavel_botao_MouseDown(object sender, MouseEventArgs e)
        {
            pnl_pesquisar_responsavel_botao.BackColor = Color.FromArgb(51, 133, 148);
        }
        private void pnl_pesquisar_responsavel_botao_MouseUp(object sender, MouseEventArgs e)
        {
            pnl_pesquisar_responsavel_botao.BackColor = Color.FromArgb(16, 118, 137);
        }
        private void pnl_pesquisar_responsavel_botao_MouseHover(object sender, EventArgs e)
        {
            pnl_pesquisar_responsavel_botao.BackColor = Color.FromArgb(16, 118, 137);
        }
        private void pnl_responsavel_botao_MouseUp(object sender, MouseEventArgs e)
        {
            pnl_responsavel_botao.BackColor = Color.Orange;
        }
        private void pnl_responsavel_botao_MouseLeave(object sender, EventArgs e)
        {
            pnl_responsavel_botao.BackColor = Color.Transparent;
        }
        private void pnl_responsavel_botao_MouseHover(object sender, EventArgs e)
        {
            pnl_responsavel_botao.BackColor = Color.Orange;
        }
        ...
        {
            pnl_responsavel_botao.BackColor = Color.Goldenrod;
        }
        #endregion
    }        
}
