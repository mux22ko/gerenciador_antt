...
{
    public partial class Uc_atendimento : UserControl, uc_identificacao, conteudos_dinamicos
    {
        #region DADOS
        ...
        public Uc_atendimento(frm_principal principal)
        {
        ...
        {
           utilidades.carregarConteudoUControle(this,this.pnl_conteudo,false,new Uc_atendimento_cadastro(principal));
           this.Refresh();
        }        
        private void pnl_pesquisar_atendimento_botao_Click(object sender, EventArgs e)
        {
          utilidades.carregarConteudoUControle(this,this.pnl_conteudo,false,new Uc_atendimento_pesquisa(principal));
          this.Refresh();
        }
        ...
        {
            return "Área de gerenciamento de Atendimentos";
        }
        ...
        {
            pnl_pesquisar_atendimento_botao.BackColor = Color.FromArgb(73, 73, 197);
        }
        ...
        {
            pnl_pesquisar_atendimento_botao.BackColor = Color.FromArgb(56, 56, 208);
        }
        private void pnl_pesquisar_atendimento_botao_MouseDown(object sender, MouseEventArgs e)
        {
            pnl_pesquisar_atendimento_botao.BackColor = Color.FromArgb(107, 107, 191);
        }
        private void pnl_cadastrar_atendimento_botao_MouseEnter(object sender, EventArgs e)
        {
            pnl_pesquisar_atendimento_botao.BackColor = Color.FromArgb(73, 73, 197);
        }
